	...
	public:
		Table(void)
		{
			...
			for (int i = 1; !file.eof(); ++i) {
				...
				this->dataGridView1->Rows[i]->Cells[9]->Value = Row.stepDec;
				this->dataGridView1->Rows[i]->Cells[10]->Value = Row.stepInc;
			}
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Column10
			// 
			this->Column10->HeaderText = L"Ум.шага";
			this->Column10->Name = L"Column10";
			// 
			// Column11
			// 
			this->Column11->HeaderText = L"Ув.шага";
			...
			this->ClientSize = System::Drawing::Size(606, 367);
